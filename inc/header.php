...
// Calculate total cart item count including multiples
$cartItemCount = 0;
foreach ($_SESSION['cart'] as $product_id => $qty) {
    $cartItemCount += $qty; // Count each item individually
}
...
<head>
    ...
    <link rel="icon" type="image/png" href="https://godzilla-store.infinityfree.me/icon-title.png">
    <link rel="shortcut icon" type="image/png" href="https://godzilla-store.infinityfree.me/icon-title.png">

    <!-- Open Graph: عند مشاركة اللينك -->
    <meta property="og:title" content="Godzilla Store">
    <meta property="og:description" content="Best supplements store">
    <meta property="og:image" content="https://godzilla-store.infinityfree.me/og-image.png">
    <meta property="og:url" content="https://godzilla-store.infinityfree.me/index.php">
    ...
    <title>
        <?php
        echo (isset($page_title) && !empty($page_title)) ? ucfirst($page_title) : "Godzilla Store";
        ?>
        | Godzilla Supplement
    </title>
    ...
    <style>
        ...
        /* Navbar styles - Transparent and Fixed */
        .navbar {
        ...
        /* --- Responsive Fixes (Addition Only) --- */
        ...
        .navbar-toggler-icon {
            background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba(243, 156, 18, 1)' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e") !important;
        }
...
<body>
    ...
    <!-- Start Navbar -->
    <nav class="navbar navbar-expand-lg admin-navbar sticky-top" id="nav1">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="index.php" style="align-items: flex-start;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    <li class="nav-item">
                        <a class="nav-link" id="nv" aria-current="page" href="index.php">
                            Home
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="nv" aria-current="page" href="aboutUs.php">
                            About Us
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="nv" href="products.php">
                            Products
                        </a>
                    </li>
                    <li class="nav-item position-relative">
                        <a class="nav-link" id="nv" href="cart.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="nv" href="login.php">
                            Admin Dashboard
                        </a>
                    </li>
                </ul>
